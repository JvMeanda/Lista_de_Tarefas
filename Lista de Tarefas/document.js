...
const validarInput = () => {
    return inputNovaTarefa.value.trim().length > 0
}
...
inputNovaTarefa.addEventListener('keypress', (e) => {
    ...
    if(e.keyCode == 13) {
        ...
        const inputValidation = validarInput();
        if(!inputValidation) {
            return inputNovaTarefa.classList.add('error')
        }
        else if(inputValidation) {
             inputNovaTarefa.classList.remove('error')
        }
